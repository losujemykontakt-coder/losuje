...
echo "🚀 Szybkie wdrożenie na OVH - losuje.pl"
echo "======================================="
...
if [ -z "$SERVER_IP" ]; then
    ...
    echo "SERVER_IP=\"51.77.220.61\"  # Zastąp swoim IP"
    exit 1
fi

print_status "Rozpoczynam szybkie wdrożenie dla $DOMAIN na $SERVER_IP..."
...
tar -czf lotek-app.tar.gz frontend/build/ backend/
