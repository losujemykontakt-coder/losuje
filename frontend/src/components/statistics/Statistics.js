  ...
  useEffect(() => {
    ...
    const fetchStats = async () => {
      try {
        ...
        const response = await fetch(`${process.env.REACT_APP_API_URL || ''}/api/statistics/${selectedGame}`, {
          method: 'GET',
          headers: {
          ...
          <button 
            onClick={async () => {
              ...
              try {
                ...
                const response = await fetch(`${process.env.REACT_APP_API_URL || ''}/api/update-stats/${selectedGame}`, { 
                  method: 'POST',
                  headers: {
                    'Content-Type': 'application/json'
                  }
            ...
            onClick={async () => {
              ...
              try {
                console.log('🔄 Rozpoczynam aktualizację wszystkich statystyk...');
                                  const response = await fetch(`${process.env.REACT_APP_API_URL || ''}/api/refresh-stats`, { 
                  method: 'POST',
                  headers: {
                    'Content-Type': 'application/json'
                  }
