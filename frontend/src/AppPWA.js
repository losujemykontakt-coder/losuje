...
import { logoutUser, onAuthStateChange } from './utils/firebaseAuthPWA';
import {
  getUserSubscription,
  getPaymentHistory,
  getUserStatus,
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#f5f5f5' }}>
      ...
      <nav style={{
        ...
        <button onClick={() => navigate('/payments')} style={menuBtnStyle(location.pathname === '/payments')}>
          💳 Płatności
        </button>
      </nav>
